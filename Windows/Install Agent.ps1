...
Invoke-WebRequest -Uri https://packages.wazuh.com/4.x/windows/wazuh-agent-4.5.2-1.msi -OutFile ${env:tmp}\wazuh-agent.msi; msiexec.exe /i ${env:tmp}\wazuh-agent.msi /q WAZUH_MANAGER='178.218.246.60' WAZUH_REGISTRATION_SERVER='178.218.246.60' WAZUH_AGENT_GROUP='Walbrzych' WAZUH_AGENT_NAME='Agent_name' 
$Insert_Test = $true
Write-Host ""
